...
const Dashboard = () => {
    ...
    return (
        <div className='w-screen flex'>
            <div className='w-[25%] h-screen bg-[#87CEFA] overflow-scroll'>
            ...
            <div className='w-[50%] h-screen bg-[#F5FFFA] flex flex-col items-center'>
                {
                    messages?.receiver?.fullName &&
                    <div className='w-[75%] bg-[#FFE4E1] h-[80px] my-14 rounded-full flex items-center px-14 py-2'>
                    ...
                    <div className='p-14'>
                        {
                            messages?.messages?.length > 0 ?
                                messages.messages.map(({ message, user: { id } = {} }) => {
                                    return (
                                        <>
                                            <div className={`max-w-[40%] rounded-b-xl p-4 mb-6 ${id === user?.id ? 'bg-[#663399] text-white rounded-tl-xl ml-auto' : 'bg-[#800080] rounded-tr-xl text-white'} `}>{message}</div>
            ...
            <div className='w-[25%] h-screen bg-[#E0FFFF] px-8 py-16 overflow-scroll'>
